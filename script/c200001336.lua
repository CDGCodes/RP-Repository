...
function s.filter1(c,e,tp)
	return c:IsLevel(8) and c:IsType(TYPE_SYNCHRO) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_SYNCHRO,tp,false,false)
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sc then
		...
		local sg=Duel.SelectMatchingCard(tp,s.filter3,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil,tp,sc)
		sg:AddCard(tuner)
