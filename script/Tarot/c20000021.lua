--Tarot - XXI - The World
local s,id=GetID()
function c20000021.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMixN(c,true,true,20000020,1,aux.FilterBoolFunctionEx(Card.IsSetCard,0x13a),3)
...
function s.matfilter(c,fc,sumtype,tp)
	return c:IsSetCard(0x13a,fc,sumtype,tp) and c:IsLevelAbove(6)
end
function s.atkval(e,c)
	return Duel.GetMatchingGroupCount(Card.IsSetCard,e:GetHandler():GetControler(),LOCATION_GRAVE,0,nil,0x13a)*-200
end
--destroy
