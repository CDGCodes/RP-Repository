...
function s.initial_effect(c)
    ...
    c:EnableReviveLimit()
    aux.AddFusionProcMix(c, true, true, aux.FilterBoolFunction(Card.IsSetCard,0x32), aux.FilterBoolFunction(Card.IsSetCard,0x32), aux.FilterBoolFunction(Card.IsCode,CARD_BLAZE_ACCELERATOR))
...
function s.ffilter2(c)
    return c:IsCode(CARD_BLAZE_ACCELERATOR)
end
